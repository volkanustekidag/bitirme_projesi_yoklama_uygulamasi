...
class TeacherNewUserDetails extends StatefulWidget {
  ...
  _TeacherNewUserDetailsState createState() =>
      _TeacherNewUserDetailsState(teacherNameSurname: teacherNameSurname);
}
...
class _TeacherNewUserDetailsState extends State<TeacherNewUserDetails> {
  ...
  _TeacherNewUserDetailsState({@required this.teacherNameSurname});

  @override
  void initState() {
    super.initState();

    var nameSurname = teacherNameSurname.split(" ");
